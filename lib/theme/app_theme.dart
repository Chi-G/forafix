...
class AppTheme {
  ...
  // Professional Service Spectrum Color Palette
  static const Color primaryLight =
      Color(0xFF2563EB); // Deep blue for trust and reliability
  static const Color primaryVariantLight = Color(0xFF1D4ED8);
  static const Color secondaryLight =
      Color(0xFF10B981); // Professional green for success states
  ...
  static const Color onBackgroundLight =
      Color(0xFF111827); // Near-black for WCAG AAA compliance
  ...
  static const Color borderLight =
      Color(0xFFE5E7EB); // Subtle gray for content separation
  static const Color borderDark = Color(0xFF374151);

  // Text colors with proper emphasis levels
  static const Color textPrimaryLight =
      Color(0xFF111827); // Near-black for body text
  ...
  /// Light theme with Professional Service Spectrum design
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation for service booking apps
    ...
    // Button themes for service booking flow
  ...
  /// Dark theme with Professional Service Spectrum design
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for service titles and navigation
