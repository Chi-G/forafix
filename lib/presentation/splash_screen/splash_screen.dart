...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget _buildLogo() {
    return Container(
      ...
      height: 32.w,
      decoration: BoxDecoration(
        color: AppTheme.lightTheme.colorScheme.surface.withOpacity(0.2),
        borderRadius: BorderRadius.circular(6.w),
        boxShadow: [
          BoxShadow(
            color: AppTheme.lightTheme.colorScheme.shadow.withOpacity(
              0.3,
            ),
            blurRadius: 20,
    ...
    return Positioned.fill(
      child: CustomPaint(
        painter: ParticleEffectsPainter(
          ...
          primaryColor: AppTheme.lightTheme.colorScheme.surface.withOpacity(
            0.1,
          ),
          secondaryColor: AppTheme.lightTheme.colorScheme.surface.withOpacity(
            0.05,
          ),
        ),
      ),
          ...
          child: Stack(
            children: [
              ...
              CircularProgressIndicator(
                ...
                backgroundColor:
                    AppTheme.lightTheme.colorScheme.surface.withOpacity(0.3),
              ),
            ],
          ),
        ),
